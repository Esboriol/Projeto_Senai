document.addEventListener('DOMContentLoaded', () => {
   ...
   const containerNS = document.getElementById('card-container-NS');
   ...
   nsCards.sort((a, b) => statusPriority[a.status] - statusPriority[b.status]);

   // Adiciona todos os cards ao contêiner
   nsCards.forEach(cardInfo => {
