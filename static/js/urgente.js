document.addEventListener('DOMContentLoaded', () => {
   ...
   const containerU = document.getElementById('card-container-U');
   ...
   urgencyCards.sort((a, b) => statusPriority[a.status] - statusPriority[b.status]);

   // Adiciona todos os cards ao contêiner
   urgencyCards.forEach(cardInfo => {
